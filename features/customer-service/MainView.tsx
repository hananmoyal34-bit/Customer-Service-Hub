    ...
    return (
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
                <ServiceCard title="Product Support & Upgrades" description="For damaged products, warranty claims, or to request a product upgrade." onClick={() => setView('productSupport')} />
