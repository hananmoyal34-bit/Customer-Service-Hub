            ...
            >
                ...
                <form onSubmit={handleReview} className="space-y-6">
                    ...
                    <div>
                        ...
                        <input name="invoiceNumber" type="text" required={!showNoInvoice} placeholder="Located on your confirmation email" className="mt-1 block w-full p-2 border border-gray-300 rounded-md shadow-sm" />
                    </div>
                    ...
                    <div>
                        <label className="block text-sm font-medium text-gray-700">Message (Ticket Notes)</label>
